@echo off
REM # Este programa es un ejemplo para nuestro curso de Unity
REM # Hoy aprenderemos a publicar y actualizar nuestro código online
REM # Para ello utilizaremos la plataforma GitHub
...
echo. Mensaje de [Castiel] para el grupo:  "skibidi sigma"
